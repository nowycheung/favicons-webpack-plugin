...
module.exports.compileTemplate = function compileTemplate (options, context, compilation) {
  ...
  var reFaviconsWebpackPluginConfigKeys = ['logo', 'prefix', 'emitStats', 'statsFilename', 'inject'];
  ...
  (childCompiler.hooks
    ? childCompiler.hooks.compilation.tap.bind(childCompiler.hooks.compilation, 'ReFaviconsWebpackPluginCompilation')
    ...
    (compilation.hooks
      ? compilation.hooks.optimizeChunkAssets.tapAsync.bind(compilation.hooks.optimizeChunkAssets, 'ReFaviconsWebpackPluginOptimizeChunkAssets')
